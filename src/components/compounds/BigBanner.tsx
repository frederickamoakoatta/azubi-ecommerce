    ...
    return (
        <div className="w-full h-[450px] rounded-lg relative overflow-hidden bg-primary flex flex-row justify-start items-center px-10">
            ...
            <div className="w-full flex flex-row justify-end items-center px-15">
                <ProductText className="absolute z-100 w-[25vw]" mode={'dark'} hasSubTitle={false} title={'ZX9 SPEAKER'} description={'Upgrade to premium speakers that are phenomenally built to deliver truly remarkable sound.'}>
